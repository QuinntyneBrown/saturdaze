...
| --- | ------------------------------------------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| 01  | [Schedule Ingestion](01-schedule-ingestion/README.md) | Draft  | How fresh `LocalEvent` / `Activity` / `Restaurant` rows enter the catalogs. Replaces hand-curated JSON seeds with AI-driven weekly deep research. |
